...
namespace WebApplication1.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public void AddToCart(int supplierproductID, int quantity)//SelectedItemsInCartVM selectedItems)
        {
            ...
            CustomerSelected_SupplierProduct selected_Item = selectedItemsRepo.getall().Where(s => s.CustomerID == customer.ID).FirstOrDefault(item => item.Supplier_ProductID == supplierproductID);
